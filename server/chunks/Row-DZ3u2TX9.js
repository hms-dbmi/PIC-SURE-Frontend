import { h as null_to_empty, a as subscribe, n as noop } from './lifecycle-DtuISP6h.js';
import { c as create_ssr_component, e as escape, a as add_attribute, b as each, h as add_classes, v as validate_component, m as missing_component } from './ssr-BRJpAXVH.js';
...
const Row = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<tr id="${"row-" + escape(index.toString(), true)}" class="${escape(null_to_empty(isClickable ? "cursor-pointer" : ""), true) + " svelte-1ho0u1e"}"${add_attribute("tabindex", isClickable ? 0 : -1, 0)}>${each(columns, (column, colIndex) => {
...
//# sourceMappingURL=Row-DZ3u2TX9.js.map
