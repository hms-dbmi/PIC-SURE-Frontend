...
const Stats = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="flex flex-col items-center w-full mt-auto p-4 bg-surface-300-600-token"><h2 class="m-4" data-svelte-h="svelte-c8j8ir">Data Summary</h2> ${$authStats.length > 0 ? `${validate_component(Stat, "Stat").$$render(
    $$result,
    {
      stats: authStats,
      auth: true,
...
//# sourceMappingURL=_page.svelte-HgRbVQ78.js.map
