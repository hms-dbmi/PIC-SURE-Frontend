import { a as subscribe, k as createEventDispatcher } from './lifecycle-DtuISP6h.js';
import { c as create_ssr_component, a as add_attribute, v as validate_component, e as escape, b as each } from './ssr-BRJpAXVH.js';
import './client-BR749xJD.js';
import { g as getToastStore } from './stores2-Cy1ftf_v.js';
import './ProgressBar.svelte_svelte_type_style_lang-3a6XZCfa.js';
import './Connections-CMtfWsSQ.js';
...
const RequiredFieldsList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<fieldset class="border border-surface-300-600-token"><legend class="px-2 ml-2">Required Fields:
    <button type="button" class="text-primary-600-300-token hover:text-secondary-600-300-token" aria-label="Add New Field" title="Add New Field" data-testid="required-field-new-btn" ${enableNewField ? "disabled" : ""}><i class="${"fa-solid fa-square-plus fa-xl " + escape(enableNewField ? "opacity-50" : "", true)}"></i></button></legend> ${enableNewField ? `${validate_component(RequiredFieldRow, "RequiredFieldRow").$$render($$result, {}, {}, {})}` : ``} ${each(fieldList, (field, index) => {
