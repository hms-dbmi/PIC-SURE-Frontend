...
import { P as PicsurePrivileges, r as routes, f as features, B as BDCPrivileges } from './configuration-CJ60Yp9o.js';
...
function isTokenExpired(token) {
  try {
    return getTokenExpiration(token) < (/* @__PURE__ */ new Date()).getTime();
  } catch (error2) {
    console.error("Error checking token expiration: " + error2);
    return true;
  }
}
...
export { isLoggedIn as a, userRoutes as b, getTokenExpirationAsDate as c, getUser as d, getTokenExpiration as e, isTopAdmin as f, get as g, put as h, isTokenExpired as i, del as j, post as p, user as u };
//# sourceMappingURL=User-DLjB6rDR.js.map
