import { x as push, T as store_get, W as unsubscribe_stores, z as pop, a5 as store_mutate, U as copy_payload, V as assign_payload, K as escape_html, D as DEV, y as setContext, M as attr_class, R as ensure_array_like, N as attr, P as stringify, J as getContext, _ as await_block } from './index-BKfiikQf.js';
...
import { u as user, p as post } from './User-DPh8mmLT.js';
import { a as resources, b as branding, f as features, s as settings } from './configuration-D-fruRXg.js';
import { w as writable, h as get } from './exports-CKriv3vT.js';
import { E as ExportStore, e as exports } from './Export-cYFOztwS.js';
import { h as hasGenomicFilter, c as filters, t as totalParticipants } from './Filter-4LYIgLGB.js';
import './Dictionary-DkgC0mju.js';
import './toaster-DzAsAKEJ.js';
import { o as onDestroy } from './machine.svelte-D_VZYMjT.js';
import { C as Content, A as AngleButton } from './Content-CXUsf3rW.js';
...
async function createDatasetName(queryId, name) {
  ...
  return await post("picsure/dataset/named", { queryId, name });
}
...
//# sourceMappingURL=_page.svelte-pJATQ7Hi.js.map
