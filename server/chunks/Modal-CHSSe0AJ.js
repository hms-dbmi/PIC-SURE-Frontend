import { x as push, O as attr, N as attr_class, Q as stringify, P as clsx, Z as bind_props, z as pop, R as props_id, T as spread_attributes, M as escape_html } from './index-BYsoXH7a.js';
import { d as createMachine, r as raf$1, q as getComputedStyle, s as trackDismissableElement, p as createAnatomy, v as mergeProps$1, x as getDocument, y as setStyleProperty, z as setStyle, A as isIos, B as getTabbables, C as getFocusables, D as isTabbable, E as getTabIndex, F as addDomEvent, G as getActiveElement, H as getEventTarget, J as isDocument, K as isFocusable } from './User-CGCqDR6a.js';
import { u as useMachine, t as toStyleString, n as normalizeProps, c as createProps } from './Loading-D4A6B7i5.js';
    ...
    Array.prototype.forEach.call(parent.children, (node) => {
      if (elementsToKeep.has(node)) {
        ...
        try {
          ...
          const alreadyHidden = attr2 === "true";
  ...
  $$payload.out.push(`<!--]--> `);
  {
    let content = function($$payload2) {
      ...
      if (withDefault) {
        ...
        if (footerButtons) {
          $$payload2.out.push("<!--[-->");
          $$payload2.out.push(`<footer class="modal-footer flex justify-end space-x-2 mt-6"><button type="button"${attr_class(`btn ${stringify(cancelClass)}`)}>${escape_html(cancelText)}</button> `);
          if (onconfirm) {
            $$payload2.out.push("<!--[-->");
...
//# sourceMappingURL=Modal-CHSSe0AJ.js.map
