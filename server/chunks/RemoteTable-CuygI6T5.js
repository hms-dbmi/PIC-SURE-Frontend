import { x as push, S as ensure_array_like, N as attr_class, M as escape_html, O as attr, Q as stringify, P as clsx, Z as bind_props, z as pop, U as store_get, X as unsubscribe_stores, a5 as maybe_selected, Y as await_block, V as copy_payload, W as assign_payload, a2 as attr_style } from './index-C9dy-hDW.js';
import { d as getConceptDetails, e as getHierarchyConcepts } from './Dictionary-Cym6J1qH.js';
...
function HierarchyComponent($$payload, $$props) {
  ...
  async function getHierarchy() {
    ...
    try {
      ...
      const rootNode = hierarchyConcepts.reduce(
        (parent, concept) => {
  ...
  function $$render_inner($$payload2) {
    ...
    await_block(
      ...
      getHierarchy(),
      () => {
        Loading($$payload2, { ring: true, size: "small" });
      },
      (treeNodes) => {
        RadioTree($$payload2, {
          fullWidth: true,
...
//# sourceMappingURL=RemoteTable-CuygI6T5.js.map
