import { x as push, U as copy_payload, V as assign_payload, Y as bind_props, z as pop, S as spread_attributes, P as stringify, K as escape_html, N as attr } from './index-C5NonOVO.js';
      ...
      $$payload2.out += `<div${spread_attributes(
        {
          ...
          style: `background-color: var(--color-${stringify(color)}-100); opacity: 0.90;${stringify(floating.floatingStyles)}`,
...
export { Popover as P };
//# sourceMappingURL=Popover-D0sAJhG1.js.map
