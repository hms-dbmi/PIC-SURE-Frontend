import { x as push, V as copy_payload, W as assign_payload, Z as bind_props, z as pop, T as spread_attributes, Q as stringify, M as escape_html, O as attr } from './index-C9dy-hDW.js';
  ...
  function $$render_inner($$payload2) {
    ...
    if (open) {
      ...
      Floating_arrow($$payload2, {
        ...
        fill: `var(--color-${stringify(color)}-100)`,
        get ref() {
          return elemArrow;
        },
        set ref($$value) {
...
export { Popover as P };
//# sourceMappingURL=Popover-eIX_ze36.js.map
