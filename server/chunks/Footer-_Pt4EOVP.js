...
import { u as user } from './User-DLjB6rDR.js';
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div></div>` : ``} <footer id="main-footer" class="flex relative"><ul>${features.termsOfService ? `<li><button class="hover:underline text-xs" data-svelte-h="svelte-ao52jb">Terms of Service</button></li>` : ``} ${each(branding?.footer?.links, (link) => {
...
//# sourceMappingURL=Footer-_Pt4EOVP.js.map
