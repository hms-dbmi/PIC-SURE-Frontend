import { x as push, T as store_get, a1 as head, W as unsubscribe_stores, z as pop, K as escape_html, N as attr, M as attr_class, P as stringify, R as ensure_array_like, U as copy_payload, V as assign_payload, Z as store_set, a0 as derived } from './index-BKfiikQf.js';
import { b as branding, a as resources } from './configuration-D-fruRXg.js';
import './client-HRCS46UK.js';
import { p as page } from './stores-DhwnhD2d.js';
import { C as Content } from './Content-CXUsf3rW.js';
import { C as CardButton } from './CardButton-CFKFjxAJ.js';
import { w as writable } from './exports-CKriv3vT.js';
import './index2-CvuFLVuQ.js';
import { g as get } from './User-DPh8mmLT.js';
import { g as getFiltersByType } from './Filter-4LYIgLGB.js';
import './Export-cYFOztwS.js';
import './index-BB9JrA1L.js';
import { P as Popover } from './Popover-3fcJP7wJ.js';
import { s as selectedGenes, c as clearGeneFilters, v as variantData, a as selectedConsequence, b as selectedFrequency, d as consequences, p as populateFromGeneFilter, e as addConsquence, r as removeConsequence } from './GeneFilter-Cyp2KRCs.js';
import { t as toaster } from './toaster-DzAsAKEJ.js';
import { O as OptionsSelectionList } from './OptionsSelectionList-BuyVKVAm.js';
...
function SNPSearch($$payload, $$props) {
  ...
  let snp = defaultSnp;
  $$payload.out += `<div id="snp-search"${attr_class(`grid grid-col-1 gap-3 ${stringify(className || "")}`)}>`;
  Panel($$payload, {
  ...
  async function getGeneValues(search = "") {
    ...
    try {
      const response = await get(
        `picsure/search/${resources.hpds}/values/?` + new URLSearchParams({
...
function GeneSearch($$payload, $$props) {
  ...
  $$payload.out += `<div id="gene-search"${attr_class(`grid grid-col-3 gap-3 ${stringify(props.class || "")}`)}>`;
  {
    let action = function($$payload2) {
...
function _page($$payload, $$props) {
  push();
  var $$store_subs;
  let edit = store_get($$store_subs ??= {}, "$page", page).url.searchParams.get("edit") || "";
  let selectedOption = (() => {
...
//# sourceMappingURL=_page.svelte-C1M_QWOX.js.map
