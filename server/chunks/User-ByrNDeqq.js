import { w as writable, h as get$1, i as derived } from './exports-Cnt0TmSD.js';
import { e as error } from './index2-CvuFLVuQ.js';
import { B as BDCPrivileges, P as PicsurePrivileges, r as routes, f as features } from './configuration-CSskKBur.js';
import { g as goto } from './client2-CLhyDddE.js';
import { p as page } from './index3-D0mgFMjB.js';
import './client-BWx-wafP.js';
import { y as setContext, J as getContext, D as DEV } from './index-C5NonOVO.js';
...
const defaultResources = {
  ...
  search: __vite_import_meta_env__?.VITE_RESOURCE_SEARCH || "23ec804c-31c1-49eb-bbb0-a0be4eda59fa",
  hpdsOpen: "23ec804c-31c1-49eb-bbb0-a0be4eda59fa",
  hpdsAuth: "23ec804c-31c1-49eb-bbb0-a0be4eda59fa",
  queryable: []
};
...
export { createGuards as $, addDomEvent as A, getEventTarget as B, isDocument as C, isFocusable as D, getActiveElement as E, setStyleProperty as F, setStyle as G, isIos as H, INIT_STATE as I, getComputedStyle as J, trackDismissableElement as K, mergeProps as L, MachineStatus as M, observeAttributes as N, observeChildren as O, userRoutes as P, get as Q, Picsure as R, post as S, isTopAdmin as T, Psama as U, del as V, isAdmin as W, put as X, getWindow as Y, isVirtualClick as Z, isMac as _, createMachine as a, dispatchInputCheckedEvent as a0, setElementChecked as a1, trackFormControl as a2, trackPress as a3, dataAttr as a4, visuallyHiddenStyle as a5, isSafari as a6, isAnchorElement as a7, trackElementRect as a8, nextTick as a9, prevById as aa, nextById as ab, last as ac, first as ad, clickIfLink as ae, isSelfTarget as af, isComposingEvent as ag, getEventKey as ah, itemById as ai, queryAll as aj, setTabContext as ak, getTabContext as al, getTokenExpiration as am, getTokenExpirationAsDate as an, getUser as ao, refreshLongTermToken as ap, add as aq, remove as ar, setAccordionContext as as, getAccordionContext as at, loading as au, resources as av, browser as b, connect as c, memo as d, isNumber as e, getValuePercent as f, group as g, createAnatomy as h, isLoggedIn as i, createScope as j, compact as k, ensure as l, machine as m, isFunction as n, identity as o, toArray as p, isString as q, raf as r, getDocument as s, toaster as t, user as u, getTabbables as v, warn as w, getFocusables as x, isTabbable as y, getTabIndex as z };
//# sourceMappingURL=User-ByrNDeqq.js.map
