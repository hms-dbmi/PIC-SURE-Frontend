import { x as push, T as store_get, U as copy_payload, V as assign_payload, W as unsubscribe_stores, z as pop, N as attr, K as escape_html, X as await_block, _ as store_set, R as ensure_array_like, Q as props_id, S as spread_attributes, P as stringify, a4 as element, M as attr_class, $ as attr_style } from './index-C5NonOVO.js';
...
import { s as searchTerm, c as selectedFacets, e as error, t as tableHandler, l as loading, d as tour, o as openFacets, f as facetsPromise, h as hiddenFacets, i as searchPromise, S as SearchStore } from './Dictionary-10axK71X.js';
import { v4 } from 'uuid';
import { a as createMachine, $ as createGuards, w as warn, aa as prevById, ab as nextById, ac as last, ad as first, aq as add, ar as remove, h as createAnatomy, ah as getEventKey, a6 as isSafari, a4 as dataAttr, aj as queryAll, as as setAccordionContext, at as getAccordionContext } from './User-ByrNDeqq.js';
import { d as clearFilters } from './Filter-BUwQwcV6.js';
import { c as createProps, u as useMachine, n as normalizeProps, L as Loading } from './Loading-Drx6gnkR.js';
import { E as ExportStore, c as clearExports } from './Export-CTQ_v_3l.js';
import { R as RemoteTable } from './RemoteTable-Dy4YtKgc.js';
...
function FacetItem_1($$payload, $$props) {
  ...
  $$payload.out += `<label${attr("data-testid", `facet-${facet.name}-label`)}${attr("for", facet.name)} class="flex gap-1 m-1 leading-[normal]">`;
    ...
    Modal_1($$payload2, {
      ...
      children: ($$payload3) => {
        if (started) {
          ...
          $$payload3.out += "<!--[!-->";
          $$payload3.out += `<p>${html(DOMPurify.sanitize(tourConfig?.description))}</p> <footer class="modal-footer flex justify-end space-x-2 mt-6"><button type="button" class="btn border preset-tonal-primary hover:preset-filled-primary-500">Cancel</button> <button type="button" class="btn preset-filled-primary-500">Start Tour</button></footer>`;
        }
        $$payload3.out += `<!--]-->`;
      },
      $$slots: { default: true }
    });
    $$payload2.out += `<!----> <button type="button" data-testid="explorer-tour-btn" id="tourBtn" class="btn preset-filled-secondary-500 text-black hover:text-white">Take a Tour</button>`;
  }
  do {
    $$settled = true;
...
//# sourceMappingURL=TourConfiguration-Djbag161.js.map
