import { s as subscribe, c as null_to_empty, d as compute_slots, e as is_promise, n as noop } from './utils-EiTRXYbg.js';
import { c as create_ssr_component, v as validate_component, e as escape, a as add_attribute, d as add_styles, f as createEventDispatcher, h as spread, i as escape_object, m as missing_component, b as each, o as onDestroy } from './ssr-C099ZcAV.js';
import { s as storeHighlightJs } from './CodeBlock-BfRczGon.js';
...
import { f as fly } from './AddFilter.svelte_svelte_type_style_lang-DfyN2jb3.js';
...
import { u as user, a as userRoutes } from './User-D2U6RL_p.js';
import { L as Logo } from './Logo-DD8h15SA.js';
import { E as ExportStore } from './Export-DDji5yGs.js';
import { f as features, b as branding } from './configuration-5_HU3Jec.js';
import { h as hasUnallowedFilter, a as hasGenomicFilter, b as hasInvalidFilter, f as filters } from './Filter-DOEs1vKh.js';
import './GeneFilter-DO0g_qs1.js';
import './index-DzcLzHBX.js';
import { P as ProgressRadial } from './ProgressRadial-D8-DtAvy.js';
import { E as ExportStepper } from './ExportStepper-rwQdo1IR.js';
import { F as Footer } from './Footer-C4fXLTzR.js';
import hljs from 'highlight.js/lib/core';
import R from 'highlight.js/lib/languages/r';
import python from 'highlight.js/lib/languages/python';
import './exports-BGi7-Rnc.js';
import './AngleButton-C0svtr3S.js';
import './Table-0D_aobLH.js';
import './Row-DCE9feR7.js';
import './UserToken-BOMdB7Zz.js';
import './CopyButton-t8NdlniS.js';
import './CardButton-BT1nVFp5.js';
    ...
    {},
    {
      ...
      default: () => {
        return `<nav id="page-navigation"><ul>${each($userRoutes, (route) => {
          return `${route.children && route.children.length > 0 ? `<li${add_attribute("class", `has-dropdown ${dropdownPath === route.path ? "open" : ""}`, 0)}><a class="nav-link"${add_attribute("id", getId(route), 0)}${add_attribute("href", route.path, 0)}${add_attribute("aria-expanded", dropdownPath === route.path, 0)}${add_attribute("aria-current", currentPage(route), 0)}>${escape(route.text)}</a> <ul class="nav-dropdown"${add_styles({
            "visibility": dropdownPath === route.path ? "visible" : "hidden"
          })}>${each(route.children, (child) => {
            return `<li><a class="no-underline"${add_attribute("href", child.path, 0)}>${escape(child.text)}</a> </li>`;
          })}</ul> </li>` : `<li><a class="nav-link"${add_attribute("id", getId(route), 0)}${add_attribute("href", route.path, 0)}${add_attribute("aria-current", currentPage(route), 0)}>${escape(route.text)}</a> </li>`}`;
        })}</ul></nav>`;
      }
    }
  )}`;
...
const FilterWarning = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $hasInvalidFilter, $$unsubscribe_hasInvalidFilter;
  let $hasUnallowedFilter, $$unsubscribe_hasUnallowedFilter;
  let $hasGenomicFilter, $$unsubscribe_hasGenomicFilter;
  let $$unsubscribe_modalStore;
  $$unsubscribe_hasInvalidFilter = subscribe(hasInvalidFilter, (value) => $hasInvalidFilter = value);
  $$unsubscribe_hasUnallowedFilter = subscribe(hasUnallowedFilter, (value) => $hasUnallowedFilter = value);
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_hasInvalidFilter();
  $$unsubscribe_page();
  return `${validate_component(Toast, "Toast").$$render($$result, { position: "t" }, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, Object.assign({}, modalProps), {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    pageFooter: () => {
...
//# sourceMappingURL=_layout.svelte-C8lNfLtm.js.map
