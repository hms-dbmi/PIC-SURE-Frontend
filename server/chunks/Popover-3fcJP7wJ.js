import { x as push, U as copy_payload, V as assign_payload, Y as bind_props, z as pop, S as spread_attributes, P as stringify, K as escape_html, N as attr } from './index-BKfiikQf.js';
...
function Floating_arrow($$payload, $$props) {
  ...
  if (computedStrokeWidth > 0) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<path fill="none"${attr("stroke", stroke)}${attr("clip-path", `url(#${clipPathId})`)}${attr("stroke-width", computedStrokeWidth + (d ? 0 : 1))}${attr("d", dValue)}></path>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--><path${attr("stroke", computedStrokeWidth && !d ? fill : "none")}${attr("d", dValue)}></path><clipPath${attr("id", clipPathId)}><rect${attr("x", -halfStrokeWidth)}${attr("y", halfStrokeWidth * (isCustomShape ? -1 : 1))}${attr("width", width + computedStrokeWidth)}${attr("height", width)}></rect></clipPath></svg>`;
  ...
  function $$render_inner($$payload2) {
    ...
    if (open) {
      ...
      $$payload2.out += `<div${spread_attributes(
        {
          class: "popover",
          style: `background-color: var(--color-${stringify(color)}-200);${stringify(floating.floatingStyles)}`,
      ...
      if (title) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<header class="flex justify-between font-bold text-xl">${escape_html(title)}</header>`;
      } else {
        $$payload2.out += "<!--[!-->";
      }
      $$payload2.out += `<!--]--> `;
      if (message) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<article><p class="opacity-60">${escape_html(message)}</p></article>`;
      } else {
        $$payload2.out += "<!--[!-->";
        children?.($$payload2);
        $$payload2.out += `<!---->`;
...
export { Popover as P };
//# sourceMappingURL=Popover-3fcJP7wJ.js.map
