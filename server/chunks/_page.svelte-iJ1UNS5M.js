import { x as push, U as store_get, X as unsubscribe_stores, z as pop, a7 as store_mutate, y as setContext, N as attr_class, S as ensure_array_like, O as attr, M as escape_html, Q as stringify, K as getContext, Y as await_block, V as copy_payload, W as assign_payload, P as clsx, a2 as derived } from './index-BYsoXH7a.js';
import { g as goto } from './client2-2LGcfZLB.js';
import { u as user, at as resources, S as post, R as Picsure, t as toaster, au as browser } from './User-CGCqDR6a.js';
import { f as features, s as settings, b as branding } from './configuration-wjj69jIJ.js';
import { E as ExportStore, e as exports } from './Export-BN3JIXjt.js';
import { c as filters, h as hasGenomicFilter } from './Filter-D4fknGLB.js';
import { t as totalParticipants } from './ResultStore-CoMBZKfX.js';
import { f as federatedQueryMap } from './Dataset-BaGv2-UL.js';
import { l as get, w as writable } from './utils-Dn8W3aSK.js';
import { o as onDestroy, L as Loading } from './Loading-D4A6B7i5.js';
import { C as Content, A as AngleButton } from './Content-D47GFKQW.js';
import { U as UserToken } from './UserToken-DSpd45-5.js';
import { j as getInitialTree, k as getConceptTree } from './Dictionary-SO9EnU4C.js';
import '@sveltejs/kit';
...
import { C as CodeBlock, T as TabItem } from './TabItem-DMxcPd7k.js';
...
function getQueryRequest$1(addConsents = true, resourceUUID = get(resources).hpdsAuth, expectedResultType = "COUNT") {
  let query = new Query();
...
let queryRequest = { resourceUUID: "", query: new Query() };
...
function resetExportStepperState() {
  ...
  setSaveable(false);
  setQueryRequest({ resourceUUID: "", query: new Query() });
}
...
function DownloadButton($$payload, $$props) {
  ...
  async function download() {
    ...
    try {
      isDownloading = true;
      const res = await post(`${Picsure.Query}/${datasetId2}/result`, {});
...
function ExportStepper($$payload, $$props) {
  ...
  async function checkExportStatus(lastPicsureResultId) {
    ...
    return withBackoff(
      async () => {
        const res = await post(`${Picsure.Query}${queryFragment}`, query);
        if (res.status === "ERROR") {
          setLockDownload(true);
...
function _page($$payload, $$props) {
  ...
  var $$store_subs;
  let { exports: exports2 } = ExportStore;
  let queryRequest2 = getQueryRequest$1(true);
...
//# sourceMappingURL=_page.svelte-iJ1UNS5M.js.map
