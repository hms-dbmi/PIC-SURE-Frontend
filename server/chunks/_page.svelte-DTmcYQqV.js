...
const SNPSearch = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_selectedSNPs();
  return `<div id="snp-search" class="${"grid grid-col-1 gap-3 " + escape($$props.class || "", true)}">${validate_component(Panel, "Panel").$$render($$result, { title: "Search for Genomic Variants" }, {}, {
    default: () => {
...
//# sourceMappingURL=_page.svelte-DTmcYQqV.js.map
