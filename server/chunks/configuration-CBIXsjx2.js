...
const results = {
  ...
  cohortDescription: "Distribution of total patient counts across networked institutions."
};
const sitemap = [
  {
...
const datasetRequestPage = {
  searchIntro: 'The Dataset ID should be provided by the researcher in the <a class="anchor" href="https://redcap.tch.harvard.edu/redcap_edc/surveys/?s=EWYX8X8XX77TTWFR" target="_blank" rel="noopener noreferrer">RedCap Request Form</a>. After the Sample and Data Access Committee (SDAC) has approved the request, the Data Admin can send the data to the designated S3 bucket to enable the researcher to access and analyze the data using <a class="anchor" href="https://www.service-workbench.childrens.harvard.edu/" target="_blank" rel="noopener noreferrer">Service Workbench</a>.'
};
const login = {
...
const PROJECT_HOSTNAME = typeof window !== "undefined" ? `${window.location.origin}/picsure` : "https://nhanes.hms.harvard.edu/picsure";
const branding = {
...
const initializeBranding = () => {
  ...
  branding.statFields = statFields;
  branding.landing = landing;
  branding.results = results;
  branding.datasetRequestPage = datasetRequestPage;
  ...
  branding.collaborateConfig = collaboratePage;
  branding.genomic = genomic;
  branding.termsOfService = termsOfService;
};
const routes = [
  {
    path: "/dashboard",
...
const features = {
  federated: __vite_import_meta_env__?.VITE_FEDERATED === "true",
  explorer: {
    allowExport: true,
    ...
    // default true
    enableRedcapExport: __vite_import_meta_env__?.VITE_ENABLE_REDCAP_EXPORT === "true",
    enableSampleIdCheckbox: __vite_import_meta_env__?.VITE_ENABLE_SAMPLE_ID_CHECKBOX === "true",
    enableCohortDetails: __vite_import_meta_env__?.VITE_ENABLE_COHORT_DETAILS === "true",
    showTreeStep: __vite_import_meta_env__?.VITE_SHOW_TREE_STEP === "true",
    enableExportTimeseries: __vite_import_meta_env__?.VITE_EXPORT_TIMESERIES !== "false",
    // default true
    enableOrQueries: true
  },
  login: {
    open: false
  },
  analyzeApi: __vite_import_meta_env__?.VITE_ANALYZE_API !== "false",
  // default true,
  analyzeAnalysis: __vite_import_meta_env__?.VITE_ANALYZE_ANALYSIS === "true",
  // default false,
  dataRequests: true,
  manualRole: __vite_import_meta_env__?.VITE_MANUAL_ROLE === "true",
  enableSNPQuery: true,
  enableGENEQuery: true,
  requireConsents: false,
  useQueryTemplate: false,
  discover: false,
  collaborate: __vite_import_meta_env__?.VITE_COLLABORATE === "true",
  discoverFeautures: {
    enableTour: __vite_import_meta_env__?.EXPLORER_TOUR !== "false",
    // default true
  ...
  termsOfService: true,
  enforceTermsOfService: __vite_import_meta_env__?.VITE_ENFORCE_TOS_ACCEPT === "true"
};
const settings = {
  variantExplorer: {
    type: "full",
...
export { BDCPrivileges as B, PicsurePrivileges as P, branding as b, features as f, initializeBranding as i, mapPrivilege as m, routes as r, settings as s };
//# sourceMappingURL=configuration-CBIXsjx2.js.map
