import { N as attr, M as attr_class, K as escape_html, P as stringify } from './index-BKfiikQf.js';
...
function ErrorAlert($$payload, $$props) {
  ...
  if (icon) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<i class="fa-solid fa-circle-exclamation text-4xl content-center" aria-hidden="true"></i>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
...
//# sourceMappingURL=ErrorAlert-MgcOEbFF.js.map
