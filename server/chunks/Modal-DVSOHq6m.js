import { x as push, N as attr, M as attr_class, P as stringify, O as clsx, Y as bind_props, z as pop, Q as props_id, S as spread_attributes, K as escape_html } from './index-BKfiikQf.js';
import { r as raf$1, g as getDocument, G as getTabbables, H as getFocusables, J as isTabbable, K as getTabIndex, b as addDomEvent, d as getEventTarget, L as isDocument, f as isFocusable, N as getActiveElement, O as setStyleProperty, s as setStyle, P as isIos, o as createMachine, Q as getComputedStyle, p as createAnatomy, R as mergeProps$1 } from './index-BB9JrA1L.js';
import { a as trackDismissableElement } from './toaster-DzAsAKEJ.js';
import { c as createProps, u as useMachine, t as toStyleString, n as normalizeProps } from './machine.svelte-D_VZYMjT.js';
...
function Modal($$payload, $$props) {
  ...
  $$payload.out += `<span${attr_class(`${stringify(base)} ${stringify(classes)}`)} data-testid="modal">`;
  if (trigger) {
    $$payload.out += "<!--[-->";
...
function Modal_1($$payload, $$props) {
  ...
  if (!!trigger) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<button${attr("data-testid", `${stringify(testid)}-btn`)}${attr("disabled", disabled, true)}${attr_class(clsx(triggerBase))}>`;
    trigger?.($$payload);
    $$payload.out += `<!----></button>`;
  } else {
    $$payload.out += "<!--[!-->";
  ...
  $$payload.out += `<!--]--> `;
  {
    let content = function($$payload2) {
      $$payload2.out += `<div${attr("data-testid", testid)}><header data-testid="modal-wrapper-header"${attr_class(`text-2xl font-bold block ${stringify(title ? "" : "text-right")}`)}>`;
      if (title) {
        $$payload2.out += "<!--[-->";
      ...
      if (closeable) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<button data-testid="modal-close-button"${attr_class("hover:text-secondary-500", void 0, { "float-right": title })}>×</button>`;
      } else {
        $$payload2.out += "<!--[!-->";
      }
      $$payload2.out += `<!--]--></header> `;
      if (withDefault) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<article class="modal-body max-h-[200px] overflow-hidden">`;
        children?.($$payload2);
        $$payload2.out += `<!----></article> `;
        if (footerButtons) {
          $$payload2.out += "<!--[-->";
          $$payload2.out += `<footer class="modal-footer flex justify-end space-x-2 mt-6"><button type="button" class="btn border preset-tonal-primary hover:preset-filled-primary-500">${escape_html(cancelText)}</button> `;
          if (onconfirm) {
            $$payload2.out += "<!--[-->";
            $$payload2.out += `<button type="button" class="btn preset-filled-primary-500">${escape_html(confirmText)}</button>`;
          } else {
            $$payload2.out += "<!--[!-->";
          }
          $$payload2.out += `<!--]--></footer>`;
...
//# sourceMappingURL=Modal-DVSOHq6m.js.map
