...
import { S as post, R as Picsure, u as user, Q as get$1 } from './User-ByrNDeqq.js';
import { a0 as derived } from './index-C5NonOVO.js';
...
const previousSearchTerm = writable("");
...
async function updateFacetsFromSearch() {
  ...
  try {
    const response = await post(Picsure.Facets, request);
...
//# sourceMappingURL=Dictionary-10axK71X.js.map
