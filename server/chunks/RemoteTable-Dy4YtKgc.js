import { x as push, R as ensure_array_like, M as attr_class, K as escape_html, N as attr, P as stringify, O as clsx, Y as bind_props, z as pop, T as store_get, W as unsubscribe_stores, X as await_block, $ as attr_style } from './index-C5NonOVO.js';
import { b as getConceptDetails } from './Dictionary-10axK71X.js';
...
function Rows($$payload, $$props) {
  ...
  $$payload.out += `<aside${attr_class(clsx(className))}><label class="flex place-items-center">Show <select id="row-count-select" class="ml-2 rounded-xl" aria-label="Rows per page"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
...
//# sourceMappingURL=RemoteTable-Dy4YtKgc.js.map
