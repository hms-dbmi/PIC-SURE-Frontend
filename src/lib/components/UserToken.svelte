  ...
  {:then}
    <div id="user-token" class="card variant-filled-sureface">
      ...
      <footer class="card-footer mt-2">
        <CopyButton itemToCopy={$user.token || ''} class="variant-ghost-primary hover:variant-filled-primary" />
        <button
          id="refresh-button"
        ...
        >
        <button id="reveal-button" class="btn variant-ghost-primary hover:variant-filled-primary" on:click={revealToken}
