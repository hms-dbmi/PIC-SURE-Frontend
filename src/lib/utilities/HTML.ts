...
// sanitize-html's default allowedTags covers most admin-authored branding/terms
// content (h1-h6, section, p, div, span, lists, blockquote, a, u/s/sub/sup, table)
// - see sanitizeHtml.defaults.allowedTags. `img` is added on top since it's a
// typical rich-text-editor tag; iframe/video/script stay excluded as the
// highest-risk tags to allow blanket (remote/executable sources).
