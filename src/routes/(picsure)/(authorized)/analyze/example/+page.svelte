...
<Content backUrl="/analyze" title="Analyze Example">
  <div class="w-full flex flex-col items-center mb-8">
    <div>
      ...
      <p>
        First, you will need to set up your analysis workspace. This can be done in one of the BioData Catalyst cloud
        computing environments, Seven Bridges or Terra. Examples of how to programmatically access the PIC-SURE API with
        Python or R are publicly available. These include Jupyter notebooks and RStudio files, which you can access on the
        <a
          class="anchor"
      ...
      <p>
        The PIC-SURE team recommends starting with the PIC-SURE_101 example code. You can access these files in the
        <a
                class="anchor"
