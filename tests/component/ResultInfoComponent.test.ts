...
// The design's own variable, so the labels, the values and the order under test are the
// design's rather than ones invented here.
...
// The designed row order, top to bottom; Unit sits between Type and Subject Type.
...
describe('ResultInfoComponent', () => {
  ...
  describe('Variable Information', () => {
    ...
    // The continuous variable. `unit` is a real dictionary meta key - one of the nine the
    // dictionary's own search whitelists.
