 ...
 *
 * The filters here are added from the variable's own detail page. What happens afterwards -
 * the chip, its buttons, its summary text, the edit modal, the query that goes out - is what
...
test.describe('Add Filters', () => {
  ...
  // The continuous variable, whose bounds the four numeric cases below fill in.
