 ...
 * it.
 *
 * These cases reach the list through the detail page's filter panel; the list itself is the
 * same component the cohort panel's edit modal and the genomic filter render.
 *
...
/*
 * Clear has no place in the designed panel: Filter Participants takes the corner it occupied,
 * and a value comes back by unticking it where it sits, which `explorer/variable-detail`
 * covers.
 *
