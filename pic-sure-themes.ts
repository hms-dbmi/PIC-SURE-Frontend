...
export const bdcTheme: CustomThemeConfig = {
  ...
  properties: {
    ...
    '--color-secondary-900': '40 76 97', // #284c61
    // tertiary | #c31f3f
    '--color-tertiary-50': '246 221 226', // #f6dde2
    '--color-tertiary-100': '243 210 217', // #f3d2d9
    '--color-tertiary-200': '240 199 207', // #f0c7cf
    '--color-tertiary-300': '231 165 178', // #e7a5b2
    '--color-tertiary-400': '213 98 121', // #d56279
    '--color-tertiary-500': '195 31 63', // #c31f3f
    '--color-tertiary-600': '176 28 57', // #b01c39
    '--color-tertiary-700': '146 23 47', // #92172f
    '--color-tertiary-800': '117 19 38', // #751326
    '--color-tertiary-900': '96 15 31', // #600f1f
    // success | #8ed081
    '--color-success-50': '238 248 236', // #eef8ec
    '--color-success-100': '232 246 230', // #e8f6e6
    '--color-success-200': '227 243 224', // #e3f3e0
